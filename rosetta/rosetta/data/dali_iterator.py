...
def get_dali_dataset(
    config, ds_shard_id, ds_num_shards, feature_converter, total_steps, image_shape, num_classes, is_training=True
):
    assert not bool(
        feature_converter
    ...
    # TODO(awolant): What is the proper size of the dataset? How it differs between train and eval?

    return peekable_data_iterator(
        vit_pipeline,
...
def get_dali_eval_dataset(
    ...
    # TODO(awolant): Implement eval dataset. Should it reuse get_dali_dataset?
